#!/usr/bin/env bash
# macOS-compatible end-to-end LAnoBERT pipeline
# Usage: bash scripts/run_pipeline_mac.sh configs/bgl.yaml
#
...
echo "==> [1-2/5] split + preprocess"
bash scripts/ensure_data_mac.sh "$CONFIG"
